 ...
 * @author Ahsana
 */
public class MenuItemAcceeseer {
    ...
    MenuItem item = new MenuItem(id, category, description, price, veg);
        items.add(item);
    }
    ...
    public static boolean deleteItemById(int id) throws ClassNotFoundException, SQLException{
        MenuItem dummy = new MenuItem(id, "dummyCategory", "dummyCategory", 0.0, false);
